		...
		<view class="container">
			...
			<view class="detail-content">
				...
				<view class="name shop-title"
					:style='{"padding":"10rpx 24rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(255, 225, 109, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"0 6rpx ","width":"100%","lineHeight":"auto","fontSize":"32rpx","borderStyle":"dashed "}'>
					公司名称：{{detail.gongsimingcheng}}
				</view>

				<view class="detail-list-item"
					:style='{"padding":"0 24rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 4rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable"
				...
				<view class="detail-list-item"
					...
					<view class="text"
						:style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"calc(100% - 160rpx)","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'>
						{{detail.zhucezijin}}</view>
				</view>

			</view>

			<view class="time-content"
				:style='{"padding":"24rpx","boxShadow":"0 0 0px #fe6311","margin":"0 0 20rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
			...
			<view class="time-content"
				...
				<view class="content"
					...
					<rich-text style="font-size: 33upx;line-height: 50upx;letter-spacing: 5upx;"
						:nodes="detail.gongsichanpin"></rich-text>
				</view>
			</view>

			<view class="time-content"
				:style='{"padding":"24rpx","boxShadow":"0 0 16rpx rgba(0,0,0,0)","margin":"0 0 20rpx 0","borderColor":"red","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
				<view class="comoment-header"
					:style='{"padding":"0","boxShadow":"0 0 16rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,.2)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view
					...
					<view
						:style='{"padding":" 0 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255, 225, 109, 1)","color":"rgba(0, 0, 0, 1)","isBtn":true,"borderRadius":"20rpx","borderWidth":"0","width":"auto","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
				...
				<view class="cu-list comment" style="margin-top: 20upx;">
					<view
						...
						<view class="content">
							<view
								:style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
							...
							<view
								:style='{"padding":"10rpx 0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(164, 164, 164, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"auto","fontSize":"24rpx","borderStyle":"solid"}'
			...
			<view class="bottom-content cu-bar bg-white tabbar border shop"
				:style='{"padding":"0px","boxShadow":"rgb(0 0 0 / 0%) 0px 0px 12rpx","margin":"0px","borderColor":"rgb(204, 204, 204)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0px","borderWidth":"2rpx 0 0 0","width":"100%","borderStyle":"solid","height":"100rpx"}'>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			let cleanType = uni.getStorageSync('discussgongsixinxiCleanType')
			if (cleanType) {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('gongsixinxi', this.id);
				this.detail = res.data;
				// 轮播图片
				this.swiperList = this.detail.gongsihuanjing ? this.detail.gongsihuanjing.split(",") : [];
				//修改富文本的图片样式
				this.detail.gongsichanpin = this.detail.gongsichanpin.replace(/img src/gi,
			...
			async upCallback(mescroll) {
				let res = await this.$api.list('discussgongsixinxi', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussgongsixinxi/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
			...
			async onFinishTap() {
				...
				await this.$api.update('gongsixinxi', this.detail);
				this.$utils.msg('审核成功');
