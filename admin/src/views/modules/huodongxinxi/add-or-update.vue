  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="select" v-if="type!='info'" label="举办公司" prop="jubangongsi">
            <el-select :disabled="ro.jubangongsi" v-model="ruleForm.jubangongsi" placeholder="请选择举办公司">
              <el-option
          ...
          <div v-else>
            <el-form-item class="input" label="举办公司" prop="jubangongsi">
              <el-input v-model="ruleForm.jubangongsi"
                        placeholder="举办公司" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item class="textarea" v-if="type!='info'" label="活动简介" prop="huodongjianjie">
            <el-input
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.huodongjianjie" label="活动简介" prop="huodongjianjie">
              <span>{{ ruleForm.huodongjianjie }}</span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
  ...
  data() {
    ...
    return {
      addEditForm: {
        ...
        "selectFontSize": "14px",
        "btnCancelBorderColor": "rgba(238, 233, 207, 1)",
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.huodongneirong = this.ruleForm.huodongneirong.replace(reg, '../../../springbooth5wle/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
