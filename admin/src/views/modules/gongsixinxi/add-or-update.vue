<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.gongsihuanjing" label="公司环境" prop="gongsihuanjing">
          <file-upload
          tip="点击上传公司环境"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.gongsihuanjing?ruleForm.gongsihuanjing:''"
          @change="gongsihuanjingUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.gongsihuanjing" label="公司环境" prop="gongsihuanjing">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gongsihuanjing.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="注册资金" prop="zhucezijin">
          <el-input v-model="ruleForm.zhucezijin" 
              placeholder="注册资金" clearable  :readonly="ro.zhucezijin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="注册资金" prop="zhucezijin">
              <el-input v-model="ruleForm.zhucezijin" 
                placeholder="注册资金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="公司文化" prop="gongsiwenhua">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="公司文化"
                  v-model="ruleForm.gongsiwenhua" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongsiwenhua" label="公司文化" prop="gongsiwenhua">
                    <span>{{ruleForm.gongsiwenhua}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="公司产品" prop="gongsichanpin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gongsichanpin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongsichanpin" label="公司产品" prop="gongsichanpin">
                    <span v-html="ruleForm.gongsichanpin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongsimingcheng = true;
          ...
          if(o=='gongsihuanjing'){
            this.ruleForm.gongsihuanjing = obj[o];
	    this.ro.gongsihuanjing = true;
            continue;
          }
          if(o=='gongsidizhi'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='zhucezijin'){
            this.ruleForm.zhucezijin = obj[o];
	    this.ro.zhucezijin = true;
            continue;
          }
          if(o=='gongsiwenhua'){
            this.ruleForm.gongsiwenhua = obj[o];
	    this.ro.gongsiwenhua = true;
            continue;
          }
          if(o=='gongsichanpin'){
            this.ruleForm.gongsichanpin = obj[o];
	    this.ro.gongsichanpin = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.gongsichanpin = this.ruleForm.gongsichanpin.replace(reg,'../../../springbooth5wle/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.gongsihuanjing!=null) {
		this.ruleForm.gongsihuanjing = this.ruleForm.gongsihuanjing.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    gongsihuanjingUploadChange(fileUrls) {
	this.ruleForm.gongsihuanjing = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
