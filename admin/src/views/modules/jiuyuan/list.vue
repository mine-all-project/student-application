<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           prop="date" :header-align="contents.tableAlign" label="地址">
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate" :tempid="tempid"></add-or-update>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    // 获取数据列表
    getDataList() {
      this.$http({url: "yuyue/flist/救援", method: "get"}).then(({data}) => {
        if (data && data.code === 0) {
