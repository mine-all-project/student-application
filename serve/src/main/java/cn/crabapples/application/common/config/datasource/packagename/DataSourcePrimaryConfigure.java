package cn.crabapples.application.common.config.datasource.packagename;
...
@Configuration
@EnableJpaRepositories(basePackages = "cn.crabapples.application.system.dao.jpa",
...
//@EntityScan("cn.crabapples.application.system.entity")
public class DataSourcePrimaryConfigure {
    ...
    LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBeanPrimary(EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages("cn.crabapples.application.system.entity")
