...
<script type="text/html" id="toolbar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-normal" href="/nurse/case/nursing/add.html">
        ...
        table.on('tool', function (obj) {
                ...
                if (obj.event == 'del') {
                    layer.confirm('真的删除行么？', function (index) {
                        Ax.rest("/nurse/case/delete", data.id, function (data) {
                            obj.del();
                            layer.close(index);
                            layer.msg("删除成功");
                        })
                    ...
                    location.href = "/nurse/case/nursing/item.html?id=" + data.id;
                } else if (obj.event === 'edit') {
                    location.href = "/nurse/case/nursing/edit.html?id=" + data.id;
                }
            }
        );
