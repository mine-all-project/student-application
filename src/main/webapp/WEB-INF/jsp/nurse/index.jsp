    ...
    <div class="layui-side ">
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="lay-nav" lay-accordion="true">
                <li class="layui-nav-item">
                    <a lay-url="/nurse/index.html" lay-id="home">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/nurse/user/personal.html" lay-url="/nurse/user/personal.html">
                                <cite>个人资料</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/nurse/user/password.html" lay-url="/nurse/user/password.html">
                                <cite>重置密码</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/nurse/user/user.html" lay-url="/nurse/user/user.html">
                                <cite>患者管理</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/nurse/leaves/manage.html" lay-url="/nurse/leaves/manage.html">
                                <cite>留言反馈</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    <a lay-id="#" lay-url="#">
                        <i class="ri-landscape-fill"></i>&emsp;<cite>护理文书管理</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/nurse/case/advice.html" lay-url="/nurse/case/advice.html">
                                <cite>医嘱管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/nurse/case/nursing.html" lay-url="/nurse/case/nursing.html">
                                <cite>护理文书管理</cite>
                            </a>
                        </dd>
                    </dl>
            ...
            <div class="layui-tab" lay-unauto lay-allowclose="true" lay-filter="lay-tab">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src="/nurse/home.html" class="layui-iframe"></iframe>
                    </div>
                </div>
            </div>
        </div>
