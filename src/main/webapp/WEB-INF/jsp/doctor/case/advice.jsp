...
<script type="text/html" id="toolbar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-normal" href="/doctor/case/advice/add.html">
    ...
    layui.config({
        ...
        table.on('tool', function (obj) {
                ...
                if (obj.event == 'del') {
                    ...
                    location.href = "/doctor/case/advice/item.html?id=" + data.id;
                } else if (obj.event === 'edit') {
                    location.href = "/doctor/case/advice/edit.html?id=" + data.id;
                }
            }
        );
