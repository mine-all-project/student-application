...
<script type="text/html" id="toolbar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-normal" href="/doctor/case/case/add.html">
    ...
    layui.config({
        ...
        table.on('tool', function (obj) {
                ...
                if (obj.event == 'del') {
                    ...
                    location.href = "/doctor/case/case/item.html?id=" + data.id;
                } else if (obj.event === 'edit') {
                    location.href = "/doctor/case/case/edit.html?id=" + data.id;
                }
            }
        );
