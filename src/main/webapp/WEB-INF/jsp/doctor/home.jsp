        ...
        <div class="layui-fluid ew-console-wrapper">
            <div class="layui-row layui-col-space15">
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-body">
                            <p style="font-size:14px;color: rgba(0,0,0,.45);">医嘱总量
                                <span class="pull-right">
                                    <i class="ri-funds-line ri-xl" style="vertical-align: -0.3em;"></i>
                                </span>
                            </p>
                            <p class="lay-big-font">
                                <span>${count1}</span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-body">
                            <p style="font-size:14px;color: rgba(0,0,0,.45);">病例总量
                                <span class="pull-right">
                                    <i class="ri-funds-line ri-xl" style="vertical-align: -0.3em;"></i>
                                </span>
                            </p>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-body">
                            <p style="font-size:14px;color: rgba(0,0,0,.45);">检查报告总量
                                <span class="pull-right">
                                    <i class="ri-funds-line ri-xl" style="vertical-align: -0.3em;"></i>
                                </span>
                            </p>
                ...
                <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-body">
                            <p style="font-size:14px;color: rgba(0,0,0,.45);">护理文书总量
                                <span class="pull-right">
                                    <i class="ri-funds-line ri-xl" style="vertical-align: -0.3em;"></i>
                                </span>
                            </p>
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-lg12 layui-col-md12">
                    <div class="layui-card">
                        <img src="/images/admin-index.jpg" style="width: 100%; height: 400px">
                    </div>
                </div>
            </div>
        </div>
