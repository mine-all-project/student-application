...
<div class="yadmin-body animated fadeIn">
    ...
    <div style="color: #8c8888; padding: 5px 15px">
        ...
        <c:if test="${cases.status == 1}">
            <label style="margin-right: 15px">患者：***</label>
            <label style="margin-right: 15px">性别：*</label>
            <label style="margin-right: 15px">年龄：*</label>
            <label style="margin-right: 15px">联系电话：***********</label>
            <label style="margin-right: 15px">身份证：*****************</label>
            <label style="margin-right: 15px">地址：**********************</label>
        </c:if>
    </div>
    <div class="content">
