    ...
    <div class="layui-side ">
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="lay-nav" lay-accordion="true">
                <li class="layui-nav-item">
                    <a lay-url="/sys/index.html" lay-id="home">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/sys/user/personal.html" lay-url="/sys/user/personal.html">
                                <cite>个人资料</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/user/password.html" lay-url="/sys/user/password.html">
                                <cite>重置密码</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/sys/user/user.html" lay-url="/sys/user/user.html">
                                <cite>患者管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/user/nurse.html" lay-url="/sys/user/nurse.html">
                                <cite>护士管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/user/doctor.html" lay-url="/sys/user/doctor.html">
                                <cite>医生管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/user/admin.html" lay-url="/sys/user/admin.html">
                                <cite>管理员管理</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/sys/leaves/manage.html" lay-url="/sys/leaves/manage.html">
                                <cite>留言管理</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/sys/case/advice.html" lay-url="/sys/case/advice.html">
                                <cite>医嘱管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/case/case.html" lay-url="/sys/case/case.html">
                                <cite>电子病历管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/case/inspect.html" lay-url="/sys/case/inspect.html">
                                <cite>检查报告管理</cite>
                            </a>
                        </dd>
                        <dd>
                            <a lay-id="/sys/case/nursing.html" lay-url="/sys/case/nursing.html">
                                <cite>护理文书管理</cite>
                            </a>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    <a lay-id="#" lay-url="#">
                        <i class="ri-landscape-fill"></i>&emsp;<cite>费用管理</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a lay-id="/sys/cost/manage.html" lay-url="/sys/cost/manage.html">
                                <cite>费用管理</cite>
                            </a>
                        </dd>
                    </dl>
            ...
            <div class="layui-tab" lay-unauto lay-allowclose="true" lay-filter="lay-tab">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <iframe src="/sys/home.html" class="layui-iframe"></iframe>
                    </div>
                </div>
            </div>
        </div>
