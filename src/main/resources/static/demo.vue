							...
							<div class="box_account">
								...
								<div class="form_container">
									...
									<div class="form-group">
										...
										<el-dropdown>
											<el-button type="primary">
												区县<i class="el-icon-arrow-down el-icon--right"></i>
											</el-button>
											<el-dropdown-menu slot="dropdown">
												<el-dropdown-item>黄金糕</el-dropdown-item>
												<el-dropdown-item>狮子头</el-dropdown-item>
									...
									<div class="form-group">
										<input autocomplete="off" placeholder="详细地址" type="text" class="form-control"
        ...
        methods: {
            ...
            submit() {
                if (this.checkForm(this.form)) {
                    axios.post('/api/saveHousesInfo', this.form).then(({data: res}) => {
                        if (res.success) {
                            // this.getHousesList();
            ...
            handleRemove(file, fileList) {
                ...
                const id = file.id;
                console.log(file)
                console.log(_this.form.img_src)
                // let arr = this.form.img_src.split(',');
                // arr.splice(index, 1);
                // this.form.img_src = arr.join(',');
