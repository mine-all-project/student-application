<template>
	<div class="parent-body">
		...
		<el-row class="form-line">
			...
			<el-col :span="2" :offset="2"><label>出库数量</label></el-col>
			<el-col :span="8">
		...
		<el-row class="form-line">
			<el-col :span="2">
				<el-button type="primary" @click="saveForm" size="">确认出库</el-button>
			</el-col>
		</el-row>
	</div>
</template>
    ...
    module.exports = {
        ...
        methods: {
            ...
            saveForm() {
                ...
                axios.get(`/api/reduceGoodsCountsById?id=` + _this.form.id).then(response => {
                    const result = response.data;
                    console.log('通过api获取到的数据:', result);
                    if (result.status !== 200) {
                        this.$message.error('数据加载失败');
