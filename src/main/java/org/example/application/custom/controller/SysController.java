...
import org.example.application.custom.service.SysService;
...
public class SysController extends BaseController {
    ...
    private final org.example.application.custom.service.SysService sysService;
    ...
    @JwtIgnore
    @PostMapping("/login")
    public org.example.application.custom.dto.ResponseDTO loginCheck(@RequestBody UserForm form) {
        ...
        return org.example.application.custom.dto.ResponseDTO.returnSuccess("登录成功", token);
    }
    ...
    @ResponseBody
    public org.example.application.custom.dto.ResponseDTO getSysMenus(HttpServletRequest request) {
