...
public interface BaseService {
    default SystemUser getUserInfo(HttpServletRequest request, JwtConfigure configure, UserDAO userDAO, boolean isDebug) {
        String userId = "001";
        if (!isDebug) {
...
//        SystemUser sysUser = userDAO.findById(userId);
