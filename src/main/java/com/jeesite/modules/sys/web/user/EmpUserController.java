...
public class EmpUserController extends BaseController {
	...
	@ResponseBody
	public Page<EmpUser> listData(EmpUser empUser, Boolean isAll, String ctrlPermi, HttpServletRequest request,
	...
	@ResponseBody
	public List<Map<String, Object>> treeData(String idPrefix, String pId, String officeCode, String companyCode,
			String postCode, String roleCode, Boolean isAll, String isShowCode, String ctrlPermi) {
	...
	public String stuList(EmpUser empUser, Model model) {
		return "modules/sys/user/stuList";
	}

	@RequestMapping(value = "comList")
	public String comList(EmpUser empUser, Model model) {
		return "modules/sys/user/comList";
	}

	@RequestMapping(value = "editForm")
	public String editForm(EmpUser empUser, Model model) {
		User user = UserUtils.getUser();
		empUser = empUserService.get(user.getUserCode());
		model.addAttribute("empUser", empUser);
		String officeCode = empUser.getEmployee().getOffice().getOfficeCode();
		if ("student".equals(officeCode)) {
			return "modules/sys/user/stuForm";
		} else {
			return "modules/sys/user/comForm";
		}
	}

	@PostMapping(value = "saveForm")
	@ResponseBody
	public String saveForm(@Validated EmpUser empUser, HttpServletRequest request) {
		empUserService.save(empUser);
		return renderResult(Global.TRUE, text("保存成功", empUser.getUserName()));
	}

	@RequestMapping(value = "indexInfo")
	public String indexInfo(EmpUser empUser, Model model) {
		User user = UserUtils.getUser();
		empUser = empUserService.get(user.getUserCode());
		model.addAttribute("empUser", empUser);
		String officeCode = empUser.getEmployee().getOffice().getOfficeCode();
		if ("student".equals(officeCode)) {
			return "modules/sys/user/stuInfo";
		} else {
			return "modules/sys/user/comInfo";
		}
	}

	@RequestMapping(value = "userInfo")
	public String userInfo(EmpUser empUser, Model model) {
